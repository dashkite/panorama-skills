...
- **Editorial Policy**: Avoid the term "developer" in favor of an active role ("developer", "creator", etc.) and terms or acronyms based on the word "developer", such as "HX". In particular, use HX (for "human experience") instead of HX.
