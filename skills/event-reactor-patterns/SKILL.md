---
name: event-reactor-patterns
description: Expert guidance for implementing complex reactive logic using @dashkite/reactive/event-reactor. Use when components or controllers require advanced event merging, state transitions, or nested reactors.
---

# Event Reactor Patterns

> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Event Reactor Patterns Knowledge Base Article](../../kb/event-reactor-patterns/index.md).
