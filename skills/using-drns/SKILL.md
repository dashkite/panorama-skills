...
> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Using DRNs (Dynamic Resource Names) Knowledge Base Article](../../kb/using-drns/index.md).
