...
> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Using Reactive Resources Knowledge Base Article](../../kb/using-reactive-resources/index.md).
