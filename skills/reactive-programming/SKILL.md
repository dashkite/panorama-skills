...
description: Expert guidance for writing reactive event streams and reactors using CoffeeScript async generators. Use when implementing controllers, component logic, or any async iterator delegation.
---

# Reactive Programming

> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Reactive Programming Knowledge Base Article](../../kb/reactive-programming/index.md).
...
### 2. Forcing Async Semantics (`await return`)
