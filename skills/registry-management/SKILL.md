...
description: Best practices for using and mocking @dashkite/registry in tests and components. Use when you need to store or retrieve shared application services, controllers, or global state.
---

# Registry Management

> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Registry Management Knowledge Base Article](../../kb/registry-management/index.md).
...
### 3. Reactive Streams in Registry
