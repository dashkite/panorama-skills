---
name: writing-tests
description: Expert guidance for writing software tests following Dashkite's standards. Covers testing principles, cost-benefit analysis, and specific patterns for CoffeeScript/JavaScript testing using Amen and Assert.
---

# Writing Tests (Dashkite Standard)

> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Writing Tests (Dashkite Standard) Knowledge Base Article](../../kb/writing-tests/index.md).
...
When you need to verify high-level user flows, UI components, or Shadow DOM interactions, incorporate the **`writing-browser-based-tests`** skill. 
