...
> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Writing Documentation (Dashkite Standard) Knowledge Base Article](../../kb/writing-documentation/index.md).
