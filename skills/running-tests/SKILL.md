---
name: running-tests
description: Guidance for running and debugging tests in the Chicago System metarepo. Use when needing to verify code changes or investigate test failures.
---

# Running Tests

> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Running Tests Knowledge Base Article](../../kb/running-tests/index.md).
