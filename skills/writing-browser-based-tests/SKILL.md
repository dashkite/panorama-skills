...
> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Writing Browser-Based Tests (Dashkite Standard) Knowledge Base Article](../../kb/writing-browser-based-tests/index.md).
