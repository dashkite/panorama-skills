...
description: Expert guidance for managing GitHub repositories using the GitHub CLI (gh). Use for creating, deleting, and configuring repositories.
---

# GitHub Repository Management (gh)

> [!Note]
> For in-depth technical documentation and detailed context, refer to the [GitHub Repository Management (gh) Knowledge Base Article](../../kb/gh-repo-management/index.md).
