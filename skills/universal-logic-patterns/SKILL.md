---
name: universal-logic-patterns
description: Guidance for writing universal, platform-independent logic for models and controllers. Use when you need to ensure core logic can be tested in Node.js while supporting browser-based views.
---

# Universal Logic Patterns

> [!Note]
> For in-depth technical documentation and detailed context, refer to the [Universal Logic Patterns Knowledge Base Article](../../kb/universal-logic-patterns/index.md).
...
### 2. Move DOM Assembly to View Helpers
...
### 3. Use Environment-Agnostic Libraries
